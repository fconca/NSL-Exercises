...
private:
    ...
    int _num_exchange; // Intervallo scambi tra continenti
...
public:
    void InitializeRandomGenerator (int line); // Inizializza generatore numeri casuali
    ...
    int GetNumExchange (); // Ottieni intervallo scambi tra continenti
